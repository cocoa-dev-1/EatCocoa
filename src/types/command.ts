...
export const CommandCategoryList: EcCommandCategory[] = [
  { name: "DEFAULT", value: "기본 명령어", description: "기본 명령어를 확인합니다." },
  { name: "ADMIN", value: "관리자 명령어", description: "관리자 명령어를 확인합니다." },
  { name: "MUSIC", value: "음악 명령어", description: "음악 명령어를 확인합니다." }
]

export const CommandCategory = new Map<string, EcCommandCategory>();
CommandCategoryList.forEach((element) => CommandCategory.set(element.name, element))
